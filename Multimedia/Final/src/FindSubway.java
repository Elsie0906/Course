...
public class FindSubway {
	...
	public static void preprocess(String vidFileName, String logoFileName) {
		...
		// for(int i=0; i<logoHHist.length; i++){
		// 	System.out.print(logoHHist[i] + " ");
		// }
		// for(int i=0; i<logoWBHist.length; i++){
		// 	System.out.print(logoWBHist[i] + " ");
		// }
		// System.out.println();		
	...
	public static void findLogo(VideoFrame frameObj) {
		...
		if(logoConfidence>0.85){
			// System.out.println("Finding Subway: " + logoConfidence);
	...
	private static float getQuotientHist(int[] hHist, int[] wbHist, float[] quoHHist, float[] quoWbHist,
		...
		// for (int i = 0; i < BANDS; i++) {
		// 	if (logoHHist[i] != 0 && hHist[i] != 0) {
		// 		colorCount += 1;
		// 		totalCountGrid += hHist[i];
		// 	} 
		// }

		// if(logoWBHist[0] != 0 && wbHist[0] != 0){
		// 	colorCount += 1;
		// 	totalCountGrid += wbHist[0];
		// }

		// if(logoWBHist[1] != 0 && wbHist[1] != 0){
		// 	colorCount += 1;
		// 	totalCountGrid += wbHist[1];
		// }
