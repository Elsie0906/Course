...
private:
  ...
  ListType *table;                  // dynamic array  

  int nonEmptyList() const;         // how many non-empty list in the table

  int longestChain() const;         // how many elements in the longest list(chain)
