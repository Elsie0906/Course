...
public class WordFinder {
  ...
  private static final String ENDFLAG = ".";                // Exit the program by typing in "."
  private static final String DEFAULTFILE = "sowpods.txt";  // default dictionary file
...
**/
  public static void main(String[] args)  {    
      ...
      try {
        ...
        if( args.length == 0) {               // no parameter, use default dictionary file
...
* @param list
*    an array list full of unsorted Scrabble objects(string and its score)
**/
...
* read a word
* @param in    
*     scanner for input reader
* @return a word from user-input/ file
**/
