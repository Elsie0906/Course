...
function calculateAndDisplayRoute(directionsService, directionsDisplay){
    ...
    var start = new google.maps.LatLng(lattitude, lngitude);    // current location
...
function mapCtrl(place){
    ...
    var autocomplete = new google.maps.places.Autocomplete((document.getElementById('directionFrom')),{types: ['geocode']});
