...
function mapTabBasic(){
    ...
    text += '</tr>';
    text += '<tr><td>';
    text += '<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 container-fluid"><input type="text" placeholder="Your location"></div>';
    ...
    text += '<select>';
    text += "<option class='dropbtn'>Driving</option>";
    text += "<option class='dropbtn'>Bicycling</option>";
    text += "<option class='dropbtn'>Transit</option>";
    text += "<option class='dropbtn'>Walking</option>";
    text += '</select>';
    text += '</div>';
    text += '<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">';
    text += '<button type="submit" class="btn btn-primary">Get Direction</button>';
    text += '</div>';
    text += '</td></tr>';    
    text += '<tr><td>';
    text += '<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">';
    text += "<button type='button' class='btn btn-default'><img src='http://cs-server.usc.edu:45678/hw/hw8/images/Pegman.png' width='20px'></button>";
    text += '</div>';
    text += '</td></tr>';
