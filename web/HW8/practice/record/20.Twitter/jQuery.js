...
function resultBasic(tableBody, ctrlBody){
    ...
    text += "<button type='button' class='btn btn-default' disabled id='detailBtn'>Details <i class='fa fa-chevron-right'></i></button>";
    text += '</div>';
...
function reviewTabBasic(){
    ...
    text += '<table class="table table-condensed" align="center" style="border-top: 0.5px solid #d3d3d3;margin-top: 10px">';
    text += '<tr>';
    text += '<div class="dropdown col-xs-12 col-sm-2 col-md-2 col-lg-2">';
    ...
    text += '</ul>';
    text += '</div>'; 
    text += '<div class="dropdown col-xs-offset-12 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">';
    ...
    text += '<ul class="dropdown-menu">';
    text += '<li onclick="sortArray(this.id)" id="Default Order">Default Order</li>';
    text += '<li onclick="sortArray(this.id)" id="Highest Rating">Highest Rating</li>';
    text += '<li onclick="sortArray(this.id)" id="Lowest Rating">Lowest Rating</li>';
    text += '<li onclick="sortArray(this.id)" id="Most Recent">Most Recent</li>';
    text += '<li onclick="sortArray(this.id)" id="Least Recent">Least Recent</li>';
    text += '</ul>';
    text += '</div>'; 
    text += '</tr>';
...
function sortArray(val){
    ...
    for(var i=0; i<reviews.length; i++){
        ...
        text += "<tr>";
        text += "<td>"+ '<a href="'+ url + '" target="_blank">' +"<img src='"+ icon +"' alt='IconImg' class='img-responsive'></a></td>";
        text += "<td>";
