    ...
    $.ajax({
        ...
        success: function(response, status){
            ...
            if( obj.status != "ZERO_RESULTS" && obj.results != null){
                ...
                if(nextPage != ""){
                    text = "<button type='button' class='btn btn-default' onclick='showMeNext()'>Next</button>";
...
function showMeNext(){
    ...
    if( myStorage.getItem("next") != null){
        $( "#searchTable" ).html(myStorage.getItem("next"));
    }
    else{
        ...
        $.ajax({
            ...
            success: function(response, status){
                ...
                myStorage.setItem("previous", $("#searchTable").html());
                ...
                if( obj.status != "ZERO_RESULTS" && obj.results != null){
                    ...
                    text = "<button type='button' class='btn btn-default' onclick='showMePrevious()'>Previous</button>";  
                    $("#ctrlTable").html(text);       
                }
...
function showMePrevious(){
    ...
    myStorage.setItem("next", $("#searchTable").html());

    $( "#searchTable" ).html(myStorage.getItem("previous"));
...
function reset(){
    ...
    myStorage.removeItem("next");
    myStorage.removeItem("previous");
}
