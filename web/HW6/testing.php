...
<script type="text/javascript">
    ...
    function requestGeo(address){
        ...
        xhttp.open("GET", "place.php?loc=" + param, true);
        xhttp.send();        
    }
    ...
    function getSearchResult(jsonObj){   
        ...
        if( jsonObj != null && jsonObj.status != "ZERO_RESULTS" && jsonObj.results != null){
    ...
    function showMeResult(){   
        ...
        console.log("after get property");
