...
<?php elseif(isset($_REQUEST["p"])): ?>
    ...
    ?>  
<?php elseif(isset($_REQUEST["loc"])): ?>
    <?php
        $addr = $_REQUEST["loc"];
        echo getGeoCode($addr);
    ?> 
<?php else: ?>
...
<script type="text/javascript">
    ...
    function requestGeoLoc(address){
        ...
        xhttp.open("GET", "place.php?loc=" + param, false);
        xhttp.send();
    ...
    function getProperty(){
        ...
        if( document.myForm.location.value == "Here"){
            ...
            requestGeoLoc(address);
            //param += "address=" + address + "$" + "location="; 
        }

        param += "address=Here"+"$"+"location=" + ori_lat + "," + ori_lng; 
